...
const char *help_msg =
    ...
    "-a | --alg\n"
    "Only runs test with the named algorithm. Available algorithm: naive, div_and_conquer, strassen."
    "csvOut\n"
...
int main(int argc, char const *argv[]) {
    ...
    for (int i = 1; i < argc; i++) {
        ...
        if (s == "--help" || s == "-h") {
            ...
            if (alg_name == "naive") used_algs[0] = true;
            else if (alg_name == "div_and_conquer") used_algs[1] = true;
            else if (alg_name == "strassen") used_algs[2] = true; // refactor later!!
            else {
